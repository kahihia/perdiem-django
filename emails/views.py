...
class UnsubscribeView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        user_is_logged_in = self.request.user.is_authenticated and self.request.user == self.user
        user_is_authenticated = (user_is_logged_in or check_token(self.user, kwargs['token']))
