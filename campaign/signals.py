...
@receiver(models.signals.post_save, sender=Investment, dispatch_uid="clear_leaderboard_from_investment_handler")
@receiver(models.signals.post_save, sender=RevenueReport, dispatch_uid="clear_leaderboard_from_revenue_report_handler")
def clear_leaderboard_cache_handler(sender, instance, **kwargs):
    cache.delete('leaderboard')


@receiver(models.signals.post_save, sender=Investment, dispatch_uid="clear_profile_contexts_from_investment_handler")
